...
console.log("CONTENTFUL_MANAGEMENT_TOKEN:",CONTENTFUL_MANAGEMENT_TOKEN)
...
spaceImport({
  spaceId: "wp8xllxttby8",
  managementToken: "CFPAT-k7z-me_VskW8VsxqO-2RZdqoVJppzEn8K2-nvRnu7hI",
  content: exportFile,
})
